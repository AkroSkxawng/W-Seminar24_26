...
trueEqualSideLength=2*trueActiveRadius*Sin(Pi/8);
truePadSpacing=((trueActiveRadius-0.01)*Sqrt(2))/2; //padSpacing=0.1925?
trueBiasingThickness=0.0005;
trueBiasingSideLength=0.015;
trueReadOutThickness=trueBiasingThickness;
