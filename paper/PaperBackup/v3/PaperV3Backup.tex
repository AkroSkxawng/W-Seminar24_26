...
%	\fancyfoot[R]{\thepage}
	...
	Für jedes zu meshende Modell werden zuerst der Wafer und alle Kontakte separat konstruiert und korrekt zueinander positioniert. Anschließend werden all diese Einzelteine mittels einer Boolean-Operation zusammengefügt, damit in der Simulation auch der Übergang von den Kontakten in den Wafer und umgekehrt errechnet werden kann, und zum Schluss das fertige 3D-Modell in einzelne Tetraeder unterteilt.
