...
\end{figure}\paragraph{}
	...
	Die frühesten Aufzeichnungen vom menschlichen Kontakt mit magnetischen Effekten stammen aus dem antiken China, etwa 4000 v. Chr., wo nach \cite{yang87} bereits Magnetsteine und frühe Kompasse zur Navigation verwendet wurden.\newline
	Ausführlichere Berichte existieren ab dem 6. Jahrhundert v. Chr., etwa aus Griechenland und Indien\cite{singh19}. Thales von Milet versuchte als einer der ersten, die Anziehung von Eisen durch Magnetsteine zu erklären, indem er ihnen eine belebte Kraft zuschrieb\cite{metioui22}.\newline
	Der indische Arzt Sushruta nutzte Magnetsteine medizinisch, um Metallsplitter aus Wunden zu entfernen\cite{singh19}.\newline
	Später beschrieben Empedokles und Plutarch magnetische Phänomene mit unterschiedlichen Ansätzen – vom atomistischen Modell bis hin zu einer „unsichtbaren Ausströmung“, die Anziehung bewirke\cite{metioui22}.\paragraph{}
	
	In den folgenden Jahrhunderten kursierten zahlreiche pseudowissenschaftliche Theorien, doch es gab auch einige weitere Fortschritte. So wurden zum Beispiel in China die ersten verlässlichen Magnetkompasse entwickelt\cite{metioui22}.\newline
	Einen echten wissenschaftlichen Fortschritt brachte 1269 Peter Peregrinus de Maricourt, der den magnetischen Dipol beschrieb und erkannte, dass sich durch Zerteilen von Magneten keine Monopole erzeugen lassen\cite{metioui22}.\newline
	Robert Norman entdeckte 1581 die magnetische Inklination und zeigte, dass sich Kompassnadeln aufgrund des Erdmagnetfeldes nach unten neigen\cite{metioui22}.\newline
	William Gilbert fasste diese Erkenntnisse 1600 in De Magnete zusammen, unterschied erstmals klar zwischen Elektrizität und Magnetismus und stellte fest, dass die Erde selbst als riesiger Magnet wirkt\cite{singh19}.\paragraph{}
	
	Im 18. Jahrhundert entdeckte Charles-Augustin de Coulomb, dass die magnetische Anziehung umgekehrt proportional zum Quadrat des Abstands ist\cite{metioui22}.\newline
	Gauss und Poisson formulierten diese Beziehungen mathematisch. Zu Beginn des 19. Jahrhunderts zeigte Hans Christian Ørsted, dass elektrischer Strom Magnetfelder erzeugt, und Ampère beschrieb deren kreisförmige Struktur\cite{singh19}.\newline
	Michael Faraday entdeckte anschließend die magnetische Induktion, worauf James Clerk Maxwell die heute grundlegenden Maxwell-Gleichungen formulierte\cite{singh19}.\paragraph{}
	
	Ende des 19. Jahrhunderts untersuchten Pierre Curie, Paul Langevin und Pierre Weiss den Einfluss von Temperatur und Materialstruktur auf magnetische Eigenschaften\cite{singh19}.\newline
	Mit der Quantenmechanik in den 1920er-Jahren gelang schließlich die Erklärung magnetischer Phänomene auf atomarer Ebene. Physiker wie Van Vleck, Pauli, Heisenberg und Landau entwickelten auf Basis der Arbeiten von Curie, Weiss und Langevin die bis heute gültigen quantenmechanischen Modelle des Magnetismus\cite{singh19}.
